...
| Programmable scenarios | Private scenario execution, real consumer bots, shared world authority and reusable runner | Partial: [experimental Python client](../development/scenario-sdk.md) and [simulation-only consumer runner](../development/consumer-runner.md), explicit source files, concurrent runs and automatic failure reports; Android runner modes and expanded dependency packaging pending |
