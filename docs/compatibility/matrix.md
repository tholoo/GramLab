...
| Programmable scenarios | Private scenario execution, real consumer bots, shared world authority and reusable runner | Partial: [authenticated world control](../development/scenario-control.md) from a private process to a real bot, scoped credentials and concurrent writers; consumer SDK/launcher, packaging and automatic failure artifacts planned |
