...
| Programmable scenarios | Private scenario execution, real consumer bots, shared world authority and reusable runner | Partial: [experimental Python client](../development/scenario-sdk.md) with scoped world control, concurrent calls and explicit uncertain mutation outcomes; private scenario/real bot integration; consumer launcher, packaging and automatic failure artifacts planned |
