...
since the mention/media batch baseline have matching CI/contributor typing scopes; current full
Ruff checks and affected mypy commands pass. Contributor guidance/CI include the new strict typing scope. |
