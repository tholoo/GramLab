# Historical handoff through core16

Preserved verbatim from the handoff at commit `73703ef`. This is historical evidence,
including superseded next actions; use [the current handoff](handoff.md) for active work.
