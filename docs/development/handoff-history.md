...
This is the preserved handoff before the current-summary split. It records earlier decisions,
failures and verification; its next-action instructions are historical. Start with the
[current handoff](handoff.md) and consult this file only when investigating an earlier milestone.
