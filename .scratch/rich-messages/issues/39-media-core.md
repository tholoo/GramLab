...
Coordinator integration passes all 17 media contract, independent real-bot and public capture
cases. The original integration failure came from the independent fixture duplicating a multipart
text/file name; it is preserved and corrected. The foreign bot now uses its valid public private
chat ID so rejection proves file-identity isolation rather than missing-chat lookup. Complete bot
responses, callbacks, reuse/download/edit/restart and caption captures pass. Full core and native
