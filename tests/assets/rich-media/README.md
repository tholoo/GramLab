...
Provision the [media shell](../../../docs/development/environment.md#media-fixtures) first.
Then generate and verify the JPEG files inside the offline network guard:
