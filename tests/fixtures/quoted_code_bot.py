"""Real form-encoded bot sends and edits independently authored quoted code."""
...
initial = call(
    "sendMessage",
    {"chat_id": chat, **scene["initial"]},
)
print(json.dumps(initial), flush=True)
if sys.stdin.readline() != "edit\n":
    raise RuntimeError("Missing scenario quoted-code edit signal")
edited = call(
    "editMessageText",
    {
        "chat_id": chat,
